...
if (isset($_FILES['imagen']) && $_FILES['imagen']['error'] == 0) {
    ...
    if (move_uploaded_file($imagen_urlTemp, $carpeta_destino . $imagen_nombre)) {
        ...
        $queryCrearPokemon = "INSERT INTO pokemon (id_pokemon, imagen, nombre, tipo, tipo_2, descripcion) VALUES ('$numero', '/PokedexTp/img/pokemon/" . $imagen_nombre . "', '$nombre', '$tipo', '$segundoTipo', '$descripcion')";
