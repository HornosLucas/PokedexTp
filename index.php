        ...
        <div class="w3-modal-content w3-animate-top">
            ...
            <div class="">
                <form class="w3-container w3-card-4" action=""> <!--- MODIFICAR ACTION Y PONER PHP --->
                    ...
                    <p><button type="button" class="w3-btn w3-padding w3-teal w3-right w3-margin-bottom" style="width:120px">Modificar</button></p> <!--- ARREGLAR BOTON PARA QUE CIERRE MODAL --->
                </form>
